...
void creatMap::Go() {
	...
	//E
	 ...
	 while (true) {
		 ...
		 if (_time == 2.0||_time==4.0||_time==6.0) {
			 if (AisGo) {
				 if (!BisGo) {
		 ...
		 if (_time == 1.5||_time==3.0||_time==4.5||_time==6.0) {
		 ...
		 if (_time == 1.0|| _time == 2.0||_time==3.0||_time==4.0||_time==5.0) {
		 ...
		 //if (_time == 0.5||_time==1.0||_time==1.5||_time==2.0||_time==2.5) {
